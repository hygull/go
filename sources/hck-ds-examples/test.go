...
func storeDetails(compulsoryData interface{}, data ...interface{}) Obj {
	tempMap := make(map[string]interface{})
	obj := Obj{}
	dataName := "data"
	fmt.Println(data)
	//data = append(data, compulsoryData)   //OK...but adds data at end
	data[0] = compulsoryData
	fmt.Println(data)
...
func main() {
	...
	fmt.Println(storeDetails("Rishikesh", 24, 45.56, true))
}
